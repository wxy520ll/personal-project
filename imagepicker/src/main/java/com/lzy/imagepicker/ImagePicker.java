...
public class ImagePicker {
    ...
    private String imageParentPath = "";//配置/DCIM/camera/
    private String prefixString = "";//拍照文件的前缀
    ...
    public void takePicture(Activity activity, int requestCode) {
        ...
        String parentPath = StringUtil.isEmpty(imageParentPath) ? "/DCIM/camera/" : this.imageParentPath;
        String prxfixString = StringUtil.isEmpty(this.prefixString) ? "IMG_" : this.prefixString;
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            if (Utils.existSDCard())
                takeImageFile = new File(Environment.getExternalStorageDirectory(), parentPath);
            else takeImageFile = Environment.getDataDirectory();
            takeImageFile = createFile(takeImageFile, prxfixString, ".jpg");
